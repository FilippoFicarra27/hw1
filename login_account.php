<?php
    ...
    if(isset($_POST["mail"]) && isset($_POST["password"])){
        ...
        $res=mysqli_query($conn,"SELECT * FROM UTENTE WHERE Email='".$username."' AND Password_utente='".$password."'");
...
<html>
    ...
    <article>
            ...
            <section>
                ...
                <div id="div_registrazione_accesso">
                    <div id="div_registrazione">
                        <h2>Registrati</h2>
                        <p>per entrare nel mondo Mulino Bianco</p>
                        <a class="a_button sfondo_grigio" href="registrazione.php">Prosegui</a>
                    </div>
                    <div id="div_accesso">
                        <h2>Accedi</h2>
                        <div class="riga_grigia">
                            <p>Accedi <strong>rapidamente</strong> con un <strong>codice temporaneo</strong></p>
                            ...
                            <form method="post">
                                <p>Email</p>
                                <input class="testo_form" type="text" name="mail">
                                <p>Password</p>
                                <input class="testo_form" type="password" name="password">
                                <div id="div_submit">
                                    <input class="a_button sfondo_grigio" type="submit" value="Entra">
                                </div>
                               
                            </form>
                            <?php
                                    if(isset($errore)){
                                        echo "<p>Login o password errate</p>";
                                    }
                ...
                <p>Per conoscere come ci prendiamo cura dei tuoi dati personali, consulta la nostra <a class="sottolineato" href="https://www.mulinobianco.it/privacy" target="_blank">Privacy Policy</a></p>
            </section>
            <footer>
                <div class="div_sopra">
                    <img src="https://www.mulinobianco.it/fe-web/img/logo.png" />
